...
function App() {
  ...
  return (
    <>
         <div className="App" style={{border: '1px solid black' ,padding:"40px", backgroundColor: 'wheat',textAlign:"center"}}>
      <h1 style={{color: 'maroon'}}>Welcome to Counter 2.0</h1>
      <div>
        <button onClick={() => setCount(count - 1)} style={{border: '2px solid black', backgroundColor: 'lightpink'}} disabled={count==0}>-1</button> &nbsp;
