...
const Home = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="imagebg " style={{ marginTop: "-3.2%" }}>
        <div className="mt-5 pt-5 ms-md-3 ms-xl-5 ps-xl-5 ">
      ...
      <Container>
        ...
        <div className="row d-sm-block d-lg-flex">
          ...
          <div className="card  col-4 col-12 col-lg-4 " style={{ border: "none" }} >
            <div className="">
          ...
          <div className="card  col-4 col-12 mt-sm-5 col-lg-4 pt-sm-4 mt-lg-0 pt-lg-0 " style={{ border: "none" }}>
            <div className="">
      ...
      <div className="mt-5 pt-4 pt-md-5">
        <h1 className='fw-bold ms-5 ps-5 ms-sm-1 ps-sm-4 ms-xl-5 ps-xl-5 d-inline'>AWARD WINNERS  </h1> <span className='fw-bold'>/ SHOP ALL</span>
        <div className="d-flex w-90 ms-5 mt-4 ms-sm-0 ps-sm-0 ms-xl-4  ps-lg-5  ps-4 slider-slide pb-3" style={{ overflowX: "scroll" }}>
          {
            data.map((el) => (
        ...
        <div className="mt-5 pt-5 ms-5 ps-5 ">
          <div className="mt-5 d-sm-none d-lg-block pt-5">
        ...
        <h1 className='fw-bold ms-5 ps-5 ms-sm-1 ps-sm-3 ms-xl-5 ps-xl-5 d-inline'>NEW ARRIVALS   </h1> <span className='fw-bold'>/ SHOP ALL</span>
        </div>
        <div className="d-flex w-90 ms-5 mt-4 ms-sm-0 ps-sm-0 mb-5 ms-xl-5 ps-xl-4 ps-4 slider-slide " style={{ overflowX: "scroll" }}>
          {
            data2.map((el) => (
              <div className='marl ms-4' key={el.id}>
   ...
   <a href="https://www.youtube.com/watch?v=-hOvTOfdBDM" style={{ textDecoration:"none"}}>
        ...
        <div className="mt-5 pt-5 ms-5 d-sm-none d-lg-block ps-5 ">
          <div className="mt-5 pt-5">
        ...
        <div className="d-flex w-90 ms-5 mt-4 mb-5 ms-sm-0 ps-sm-0 ps-4 ms-xl-5 ps-xl-4 slider-slide " style={{ overflowX: "scroll" }}>
          {
            data3.map((el) => (
              <div className='marl ms-4' key={el.id}>
              <Link to={`/description/${el.id}`}>   
        ...
        <div className="mt-5 ms-5 ps-5 ms-sm-0 ps-sm-0 ms-xl-5 ps-xl-4 ">
            <h1 className='mt-5 pt-5 text-white mb-1  fw-bold ' style={{ fontSize: "60px" }}>ADVENTURE WITHIN REACH  </h1>
            <h5 className='text-white col-5 col-sm-12 col-xl-6 col-xxl-5 mb-5'>Throughout 2022 we will be partnering with four organizations: Women’s Wilderness, LGBT Outdoors, Outdoors For All Foundation, and Soul Trak Outdoors — to address common barriers to outdoor recreation with a 1% donation of all web sales, gear donation, education and awareness-raising messaging. </h5>
