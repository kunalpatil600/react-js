  ...
  return (
    <div>
      ...
      <div className="image1 pt-5 ">
        <div className="mt-5 pt-5  mt-sm-0 pt-sm-0">
      ...
      <Container>
      <div className="row p-5 p-sm-4">
        <div className="card  col-6  col-sm-12 ps-5 ps-sm-0" style={{border:"none"}}>
   ...
   <h3 className='position-absolute  text-white fw-bold ms-3  bgdark w-100 h-100 '  style={{fontSize:"50px",display:"flex", alignItems:"center"}}>FIND YOUR SLEEPING BAG</h3>
        ...
        <div className="card  col-6 col-sm-12  ps-sm-0 pe-sm-3 mt-sm-5 pe-5 pe-sm-0" style={{border:"none"}}>
   ...
   <h3 className='position-absolute text-white  fw-bold  bgdark ms-5 ps-sm-0 ps-4 h-100 '  style={{fontSize:"50px",display:"flex", alignItems:"center",  }}>FIND YOUR TENT</h3>
        </div>
      </div>
      </Container>
      {/* <Foter/> */}
